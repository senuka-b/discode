...
export default function CreateProjectDialog({open, handleClose} : {open: boolean, handleClose: () => void}) {
            ...
            onSubmit: (event) =>  {
                ...
                api.createNewProject(data).then((value) => {
                    ...
                    if (value === "file_exists") {
                        window.electron.dialog.message(`A project with the name ${name} already exists in ${location}. Create ${name} in another location or, use another name!`);
        ...
        >
            ...
            <TextField
                ...
                onClick={() => {
                    ...
                    window.electron.ipcRenderer.once("selected-folder", (location) => {
